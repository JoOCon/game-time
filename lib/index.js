...
function drawLogs() {
  const img = new Image();
  const log1 = new Log(img, 0, 295, 225, 55);
  const log2 = new Log(img, 100, 245, 225, 55);
  const log3 = new Log(img, 50, 195, 225, 55);
  const log4 = new Log(img, 250, 145, 225, 55);
  const log5 = new Log(img, 300, 95, 225, 55);
  const log6 = new Log(img, 280, 45, 225, 55);
