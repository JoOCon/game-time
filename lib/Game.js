...
class Game {
  ...
  generateLogs() {
    const log1 = new Log(this.logImg, -150, 298, 225, 52, 1.5, 'right');
    const log2 = new Log(this.logImg, 550, 248, 225, 52, 2, 'left');
    const log3 = new Log(this.logImg, -150, 198, 225, 52, .5, 'right');
    const log4 = new Log(this.logImg, 550, 148, 225, 52, 1.5, 'left');
    const log5 = new Log(this.logImg, -150, 98, 225, 52, 1, 'right');
    const log6 = new Log(this.logImg, 550, 48, 225, 52, 1, 'left');
