...
class Game {
  ...
  generateAutos() {
    const car1 = new Auto(this.carImg, 0, 605, 80, 40);
    const car2 = new Auto(this.carImg, 100, 605, 80, 40);
    const car3 = new Auto(this.carImg, 100, 505, 80, 40);
    const car4 = new Auto(this.carImg, 200, 505, 80, 40);
    const car5 = new Auto(this.carImg, 300, 505, 80, 40);
    const car6 = new Auto(this.carImg, 0, 405, 80, 40);
    const car7 = new Auto(this.carImg, 300, 405, 80, 40);
    const truck1 = new Auto(this.truckImg, 0, 555, 120, 40);
    const truck2 = new Auto(this.truckImg, 300, 555, 120, 40);
    const truck3 = new Auto(this.truckImg, 150, 455, 120, 40);
    const vehicles = [
      [car1, car2],
      [car3, car4, car5],
      [car6, car7],
